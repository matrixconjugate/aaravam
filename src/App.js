...
import { BookOpen, Users, Award, ArrowRight, ChevronRight } from 'lucide-react';

const AaravamLandingPage = () => {
  return (
    <div className="min-h-screen bg-white font-sans">
      {/* Navigation */}
      <nav className="flex justify-between items-center py-6 px-8 md:px-16 border-b border-gray-100">
        ...
        <div className="hidden md:flex space-x-8">
          <a href="#approach" className="text-gray-600 hover:text-[#e16338]">Our Approach</a>
          <a href="#impact" className="text-gray-600 hover:text-[#e16338]">Impact</a>
          <a href="#contact" className="text-gray-600 hover:text-[#e16338]">Contact</a>
        </div>
        <button className="bg-[#e16338] text-white py-2 px-6 rounded-full text-sm font-medium hover:bg-[#d55328] transition">
          Get Started
        </button>
      </nav>

      {/* Hero Section */}
      <section className="py-16 md:py-24 px-8 md:px-16 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Nurturing Independent Thinkers of Tomorrow
          </h1>
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Empower students to become problem-solvers with Aaravam Labs — a transformative STEAM program where children develop agency by tackling real-world challenges.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-[#e16338] text-white py-3 px-8 rounded-full font-medium hover:bg-[#d55328] transition flex items-center">
              Learn More <ArrowRight className="ml-2 w-4 h-4" />
            </button>
            <button className="border border-[#e16338] text-[#e16338] py-3 px-8 rounded-full font-medium hover:bg-orange-50 transition">
              For Schools
            </button>
          </div>
        </div>
  ...
  <div className="bg-orange-50 overflow-hidden relative rounded-2xl">
    ...
    {/* Right edge gradient */}
    <div className="absolute top-0 right-0 bottom-0 w-16 bg-gradient-to-l from-white to-transparent z-10"></div>
    
    {/* Bottom edge gradient */}
    <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-white to-transparent z-10"></div>
    
    {/* Left edge gradient */}
    <div className="absolute top-0 left-0 bottom-0 w-16 bg-gradient-to-r from-white to-transparent z-10"></div>
    ...
    />
      ...
      {/* Stats Section */}
      <section className="bg-orange-50 py-12 px-8 md:px-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm flex flex-col items-center text-center">
            <div className="bg-orange-100 p-3 rounded-full mb-4">
              <Users className="text-[#e16338] w-6 h-6" />
            </div>
            <span className="text-4xl font-bold text-[#e16338] mb-2">250+</span>
            <p className="text-gray-600">Students Empowered</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-sm flex flex-col items-center text-center">
            <div className="bg-orange-100 p-3 rounded-full mb-4">
              <BookOpen className="text-[#e16338] w-6 h-6" />
            </div>
            <span className="text-4xl font-bold text-[#e16338] mb-2">6</span>
            <p className="text-gray-600">Partner Schools</p>
          </div>
          <div className="bg-white p-8 rounded-xl shadow-sm flex flex-col items-center text-center">
            <div className="bg-orange-100 p-3 rounded-full mb-4">
              <Award className="text-[#e16338] w-6 h-6" />
            </div>
            <span className="text-4xl font-bold text-[#e16338] mb-2">100%</span>
      ...
      <section id="approach" className="py-16 md:py-24 px-8 md:px-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-900">Our Approach</h2>
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Aaravam Labs is a student centered program that embeds seamlessly within your existing curriculum and requires just a couple of hours each week. Students confront meaningful challenges that demand creative thinking, persistence, and self-direction allowing them to discover their capabilities, and develop the confidence to shape their own learning journeys.
              </p>
      ...
      {/* Impact Section */}
      <section id="impact" className="bg-gray-50 py-16 md:py-24 px-8 md:px-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-900">Our Impact</h2>
          <p className="text-xl text-center text-gray-700 max-w-3xl mx-auto mb-12">
            At Aaravam Labs, we have empowered 250+ students across 6 schools to discover their voices, trust their abilities, and realize their capacity to create meaningful change.
          </p>
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-12">
              <div className="bg-white p-6 rounded-xl shadow-sm w-64 h-24 flex items-center justify-center">
                <p className="font-bold text-gray-700">Malpani Ventures</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm w-64 h-24 flex items-center justify-center">
                <p className="font-bold text-gray-700 text-center">The Circle: Reinventing India, School by School</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-sm w-64 h-24 flex items-center justify-center">
                <p className="font-bold text-gray-700">Teach for India</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Education Director, Bright Futures School</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-16 px-8 md:px-16 bg-[#e16338] text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to transform education at your school?</h2>
          <p className="text-xl mb-8 opacity-90">
            Join our growing community of forward-thinking schools empowering the next generation of problem solvers.
          </p>
          <button className="bg-white text-[#e16338] py-3 px-8 rounded-full font-medium hover:bg-gray-100 transition inline-flex items-center">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-[#e16338] transition">Home</a></li>
              <li><a href="#approach" className="hover:text-[#e16338] transition">Our Approach</a></li>
              <li><a href="#impact" className="hover:text-[#e16338] transition">Impact</a></li>
              <li><a href="#" className="hover:text-[#e16338] transition">For Schools</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-[#e16338] transition">
